document.addEventListener("DOMContentLoaded", function() {
    ...
    <desc>Designed for the SVG Logo Contest in 2006 by Harvey Rayner, and adopted by W3C in 2009. It is available under the Creative Commons license for those who have an SVG product or who are using SVG on their site.</desc>
     ...
     <defs>
       <g id="SVG" fill="var(--primary-color)" transform="scale(2) translate(20,79)">
     ...
     <path id="base" fill="var(--background-color-deep)" d="M8.5,150 H291.5 V250 C291.5,273.5 273.5,291.5 250,291.5 H50 C26.5,291.5 8.5,273.5 8.5,250 Z"/>
     <g stroke-width="38.0086" stroke="var(--colored-background-1)">
       <g id="svgstar" transform="translate(150, 150)">
         <path id="svgbar" fill="var(--colored-background-2)" d="M-84.1487,-15.8513 a22.4171,22.4171 0 1 0 0,31.7026 h168.2974 a22.4171,22.4171 0 1 0 0,-31.7026 Z"/>
